...
const researchMetrics: ResearchMetric[] = [
  { label: "Fundamentals", value: "Project quality" },
  { label: "Market structure", value: "Liquidity depth" },
  { label: "On-chain", value: "Network behaviour" },
  { label: "Tokenomics", value: "Supply pressure" },
  { label: "Macro", value: "Capital environment" },
  { label: "Regulation", value: "Jurisdiction risk" },
];
            ...
            <article className="landing-terminal glass-panel-strong">
              ...
              <div className="terminal-council">
                ...
                <div>
                  ...
                  <p>
                    Zella's AI will explain verified engine outputs. It will
                    not invent market values or bypass deterministic risk
                    controls.
                  </p>
                </div>
              </div>
